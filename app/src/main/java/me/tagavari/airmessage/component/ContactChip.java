...
public class ContactChip {
    ...
    public ContactChip(Context context, String display, String address, Consumer<ContactChip> onRemove) {
        //Setting the data
        this.display = display;
        this.address = address;

        //Setting the view
        view = LayoutInflater.from(context).inflate(R.layout.chip_user, null);
